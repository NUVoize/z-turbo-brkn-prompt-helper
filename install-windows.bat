...
title FLUX 2.0 - BRKN AI Prompt Generator - Installer
...
echo %CYAN%========================================%RESET%
echo %CYAN%  FLUX 2.0 Prompt Generator Installer  %RESET%
echo %CYAN%========================================%RESET%
echo.
...
echo %CYAN%========================================%RESET%
echo.
echo %GREEN%FLUX 2.0 - BRKN AI Prompt Generator is ready to use!%RESET%
echo.
